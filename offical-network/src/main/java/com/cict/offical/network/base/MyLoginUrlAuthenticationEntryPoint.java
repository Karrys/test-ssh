...
public class MyLoginUrlAuthenticationEntryPoint implements
	...
	public void commence(HttpServletRequest request,
		 ...
		 * sb.append("{\"status\":\"error\",\"msg\":\""); sb.append("未登陆!");
		 * sb.append("\"}");
		 */

		out.write(JSON.toJSONString(Result.returnResult(1001, "未登录！")));
		out.flush();
		out.close();
	}
